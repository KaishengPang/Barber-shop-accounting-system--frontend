...
import { Button, Modal, Form, Input, InputNumber, message , Table} from 'antd';
import { PlusOutlined,DeleteOutlined } from '@ant-design/icons';
import { openConfirm } from '@/utils/ui';
import { listServiceProjectsForAll,deleteServiceProjects } from '@/services/api/serviceProjects';
    ...
    <PageContainer>
      ...
      <ProTable<API.ServiceProjectsVO>
        ...
        request={async (params = {}, sort) => {
            ...
            try {
              const response = await listServiceProjectsForAll(props);
              if (response?.list) {
